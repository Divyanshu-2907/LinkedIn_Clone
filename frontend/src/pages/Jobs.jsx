        ...
        <div className="bg-white rounded-xl shadow-sm p-6 mb-6">
          <div className="flex flex-col md:flex-row md:items-center gap-4 mb-4">
            <div className="relative flex-1">
              ...
              <form onSubmit={handleSearch} className="w-full">
                <input
                  ...
                  className="block w-full pl-10 pr-4 py-3 border border-gray-300 rounded-lg bg-white text-gray-900 placeholder-gray-500 focus:outline-none focus:ring-2 focus:ring-linkedin-500 focus:border-transparent"
                  value={searchTerm}
            ...
            <button
              ...
              className="inline-flex items-center px-6 py-3 border border-gray-300 rounded-lg shadow-sm text-sm font-medium text-gray-700 bg-white hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-linkedin-500 relative"
            >
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mb-4">
                <div>
                  ...
                  <input
                    ...
                    className="block w-full px-4 py-2 border border-gray-300 rounded-lg shadow-sm bg-white text-gray-900 focus:outline-none focus:ring-2 focus:ring-linkedin-500 focus:border-transparent"
        ...
        {loading && jobs.length === 0 ? (
          ...
          <>
            <div className="space-y-4 mb-6">
              {jobs.map((job) => (
                <div key={job._id} className="bg-white rounded-xl shadow-sm border border-gray-200 overflow-hidden hover:shadow-md transition-all">
                  <div className="p-6">
                        ...
                        <div className="flex items-start space-x-4">
                          <div className="flex-shrink-0">
                            {job.companyLogo ? (
                              ...
                              <div className="h-14 w-14 rounded-lg bg-linkedin-100 flex items-center justify-center">
                                <Building2 className="h-7 w-7 text-linkedin-600" />
                              </div>
                            )}
                          </div>
                          <div className="flex-1">
                            <div className="flex items-start justify-between flex-wrap gap-2">
                              <div>
                                <h3 className="text-lg font-semibold text-gray-900 hover:text-linkedin-500 cursor-pointer">
                                  {job.title}
                                </h3>
            ...
            {pagination.page < pagination.totalPages && (
              <div className="text-center">
                <button
                  ...
                  disabled={loading}
                  className="px-8 py-3 border border-gray-300 rounded-lg shadow-sm text-sm font-medium text-gray-700 bg-white hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-linkedin-500 disabled:opacity-50"
                >
                  {loading ? (
                    <>
          ...
          <div className="bg-white rounded-xl shadow-sm p-12 text-center">
            ...
            {activeTab !== 'all' && (
              <button
                onClick={() => setActiveTab('all')}
                className="ml-3 px-6 py-2 border border-gray-300 text-gray-700 rounded-lg hover:bg-gray-50 transition-colors font-medium"
              >
                Browse All Jobs
              </button>
            )}
